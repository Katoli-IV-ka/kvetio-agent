...
Пиши все человекочитаемые выводы, резюме и значения `analysis_records.facts` на
естественном русском языке. Имена компаний, людей, продуктов, моделей,
датасетов, URL, метрики, даты, суммы и evidence references сохраняй в исходном
виде.
